...
impl MemoryProtectionPolicy {
    ...
    pub(crate) fn apply_nx_to_uc_policy(attributes: u64) -> u64 {
...
mod tests {
    ...
    fn test_activate_compatibility_mode_not_allowed() {
        ...
        let result =
            gcd.memory_protection_policy.activate_compatibility_mode(0x1000, 0x10, "test_image.efi".to_string());
    ...
    fn test_activate_compatibility_mode_allowed() {
        ...
        with_locked_state(|| {
            ...
            let result =
                policy.activate_compatibility_mode(image_base_page as usize, image_num_pages, filename.clone());
            assert!(result.is_ok());
